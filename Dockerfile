...
RUN apk add --no-cache wget && \
    wget -LO /model.safetensors "https://civitai.com/api/download/models/691639?type=Model&format=SafeTensor&size=full&fp=fp32&token=c971befab549f15355f54427df0b66db"
